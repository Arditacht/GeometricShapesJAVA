...
public class Splash extends JWindow
{
    ...
    public void showSplash()
    {
       ...
       JLabel label = new JLabel(new ImageIcon("src/GeometricObjects/splash.gif"));
       JLabel copyrt = new JLabel ("Copyright Megapolis inc., 2011, USA Cities Database", JLabel.CENTER);
